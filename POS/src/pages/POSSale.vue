<template>
	...
	>
		...
		<StockEntryNotifications
			:is-open="showStockNotifications"
			:warehouse="shiftStore.profileWarehouse"
			@close="showStockNotifications = false"
		/>

		<!-- Reports Management Modal -->
		<Dialog
			v-model="showReportsManagement"
			:options="{ title: 'Reports', size: 'xl', dismissable: true }"
		>
...
import StockEntryNotifications from "@/components/pos/StockEntryNotifications.vue"
import ReportsManagement from "@/components/pos/ReportsManagement.vue"
...
// Stock Notifications dialog
const showStockNotifications = ref(false)

// Reports Management dialog
const showReportsManagement = ref(false)
...
function handleManagementMenuClick(menuItem) {
	...
	} else if (menuItem === "stock-notifications") {
		showStockNotifications.value = true
	} else if (menuItem === "reports") {
		showReportsManagement.value = true
	}
}
